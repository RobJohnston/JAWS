 ...
 */
class UpdateCrewAvailabilityUseCaseTest extends TestCase
{
    private PDO $pdo;
     ...
     */
    private function createCrewProfileForUser(int $userId, array $overrides = []): string
    {
     ...
     */
    private function getCrewAvailability(string $crewKey, string $eventId): ?int
    {
        $stmt = $this->pdo->prepare('
